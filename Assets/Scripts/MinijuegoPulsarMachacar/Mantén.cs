...
public class Mantén : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            slider_StartingValue = Mathf.MoveTowards(slider_StartingValue, slider_EndValue, 1.7f * Time.deltaTime);
        }
        else
        {
            slider_StartingValue = Mathf.MoveTowards(slider_StartingValue, slider_MinValue, 2f * Time.deltaTime);
            slider_Status.text = "Presiona P para calentar la cura";
        }
