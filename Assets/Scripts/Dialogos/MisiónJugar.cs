...
public class MisiónJugar : MonoBehaviour
{
    ...
    public MisiónGasolineraFin mision2;
    public bool jugar = false;
    void Update()
    {
        mision2 = FindObjectOfType<MisiónGasolineraFin>();
        if (mision2.lorena == true)
        {
    ...
    {
        if (collision.gameObject.CompareTag("Player") && mision2.lorena == true)
        {
            JugadorEnRango = true;
            if (noRepetir == false)
            {
