...
using System;
public class SangreBNegativo : MonoBehaviour
{
    ...
    [SerializeField] private GameObject sangreBNegativa;
    ...
    public bool inicioSarah = false;

    public MisiónMatilde sangreB;
    void Update()
    {
        sangreB = FindObjectOfType<MisiónMatilde>();
    ...
    private void SiguienteLinea()
    {
        ...
        else
        {
            ...
            sangreBNegativa.SetActive(true);
