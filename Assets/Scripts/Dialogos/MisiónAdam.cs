...
public class MisiónAdam : MonoBehaviour
{
    ...
    public SangreBPositiva inicioDialogo;
    void Update()
    {
        inicioDialogo = FindObjectOfType<SangreBPositiva>();
        if (inicioDialogo.inicioAdam == true)
        {
    ...
    private void SiguienteLinea()
    {
        ...
        else
        {
            ...
            noRepetir = true;
            inicioDialogo.inicioAdam = false;
            sangreActiva = true;
    ...
    {
        if (collision.gameObject.CompareTag("Player") && inicioDialogo.inicioAdam == true)
        {
            JugadorEnRango = true;
            if (noRepetir == false)
            {
