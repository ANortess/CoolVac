...
public class SangreAPositivo : MonoBehaviour
{
    ...
    [SerializeField] private GameObject sangreAPositivo;
    ...
    public MisiónKevinFin positivo;
    void Update()
    {
        positivo = FindObjectOfType<MisiónKevinFin>();
        if (positivo.seguir == true)
        {
            if (JugadorEnRango)
            {
                if (noRepetir == false)
    ...
    private void SiguienteLinea()
    {
        ...
        else
        {
            ...
            sangreAPositivo.SetActive(true);

            cogerSangre = true;
            positivo.seguir = false;
    ...
    {
        if (collision.gameObject.CompareTag("Player") && positivo.seguir == true)
        {
            JugadorEnRango = true;
        }
    }
